    ...
    <ul class="grid grid-cols-1 gap-1 sm:grid-cols-2 md:grid-cols-3 md:gap-8">
      ...
      <li class="bg-white rounded-lg shadow-xl">
          <a href="{{ route('posts.show', $post->slug)}}" class="group max-w-sm mx-auto overflow-hidden bg-white rounded-lg hover:shadow-lg dark:bg-gray-800 hover:bg-gray-200 transition duration-500 ease-in-out">
            ...
            <div class="px-6 py-4 group-hover:bg-gray-200 rounded-lg transition duration-500 ease-in-out">
                <h1 class="text-xl font-semibold text-gray-800 dark:text-white transition duration-500 ease-in-out group-hover:text-blue-800">{{ $post->title }}</h1>
